...
import { u as uploadToHuggingFace, I as IconButton, r as Clear, v as Image$1 } from "./2.DXfm8U3u.js";
import { B as BlockLabel } from "./BlockLabel.CyBK5_Yj.js";
import { E as Empty } from "./Empty.BZusk4Iv.js";
import { S as ShareButton } from "./ShareButton.DeUCjCk3.js";
...
/* empty css                                              */
import { M as ModifyUpload } from "./ModifyUpload.BjmB8Z4s.js";
import { V as Video } from "./Video.DwpGRRlL.js";
...
function create_if_block_4(ctx) {
  ...
  let if_block1 = (
    /*selected_media*/
    ((_a = ctx[23]) == null ? void 0 : _a.caption) && create_if_block_6(ctx)
  );
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      if (
        /*selected_media*/
        (_a2 = ctx[23]) == null ? void 0 : _a2.caption
      ) {
        if (if_block1) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8388608)
        ...
        ctx2[23].caption || null;
      if (dirty[0] & /*selected_media*/
      8388608)
        image_changes.class = /*selected_media*/
        ctx2[23].caption && "with-caption";
...
function create_if_block_6(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (dirty[0] & /*selected_media*/
      8388608 && t_value !== (t_value = /*selected_media*/
      ctx2[23].caption + ""))
        set_data(t, t_value);
    },
    d(detaching) {
...
function create_each_block(ctx) {
  ...
  let if_block1 = (
    /*entry*/
    ctx[49].caption && create_if_block_1(ctx)
  );
...
function instance($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    document.addEventListener("fullscreenchange", () => {
      $$invalidate(18, is_full_screen = !!document.fullscreenElement);
    });
  });
  ...
  function div_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      ...
      $$invalidate(21, container_element);
    });
  }
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("preview" in $$props2)
      $$invalidate(28, preview = $$props2.preview);
    ...
    if ("_fetch" in $$props2)
      $$invalidate(29, _fetch = $$props2._fetch);
    if ("mode" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    1073741825) {
      $$invalidate(30, was_reset = value == null || value.length === 0 ? true : was_reset);
    }
    ...
    if ($$self.$$.dirty[0] & /*value, was_reset, preview, selected_index*/
    1342177283 | $$self.$$.dirty[1] & /*prev_value*/
    1) {
      if (!dequal(prev_value, value)) {
        if (was_reset) {
          $$invalidate(1, selected_index = preview && (value == null ? void 0 : value.length) ? 0 : null);
          $$invalidate(30, was_reset = false);
        } else {
        ...
        dispatch("change");
        $$invalidate(31, prev_value = value);
      }
    }
    ...
    2) {
      {
        if (selected_index !== old_selected_index) {
          $$invalidate(32, old_selected_index = selected_index);
    ...
    if ($$self.$$.dirty[0] & /*selected_index, resolved_value*/
    131074) {
      $$invalidate(23, selected_media = selected_index != null && resolved_value != null ? resolved_value[selected_index] : null);
    }
  };
  return [
    value,
