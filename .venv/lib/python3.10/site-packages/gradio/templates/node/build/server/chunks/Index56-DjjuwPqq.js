...
import { B as Block, S as Static, j as BlockLabel, J as File$1, n as Empty, U as UploadText, o as IconButtonWrapper, q as IconButton, Q as Undo, u as Download } from './2-kIMsGnBT.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-D0MPR-jW.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-CVxx2J4m.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-DyumcqWt.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-DjjuwPqq.js.map
