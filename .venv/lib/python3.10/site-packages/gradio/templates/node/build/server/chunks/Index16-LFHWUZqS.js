import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, b as add_attribute, o as onDestroy } from './ssr-Cwm06D-i.js';
import { B as Block, S as Static, j as BlockLabel, Y as Code$2, n as Empty, q as IconButton, K as Copy$1, D as DownloadLink, u as Download$1, o as IconButtonWrapper, Z as getWorkerProxyContext } from './2-kIMsGnBT.js';
import Example from './Example6-OZyweoWA.js';
...
const lang_map = {
  python: () => import('./index33-UxnzoGly.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index34-D5dEat1-.js'),
      import('./frontmatter-CVRdTTAK.js')
    ]);
  ...
  json: () => import('./index38-CY8uLJe2.js').then((m) => m.json()),
  html: () => import('./index35-DadW4dfc.js').then((m) => m.html()),
  css: () => import('./index36-B349biby.js').then((m) => m.css()),
  javascript: () => import('./index37-DMUCNmxb.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index37-DMUCNmxb.js').then(
...
//# sourceMappingURL=Index16-LFHWUZqS.js.map
